...
<div class="grid grid-cols-2 flex-grow relative z-10">
    ...
    <div class="flex items-center justify-center">
        <div class="bg-white border border-gray-100 w-[420px] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.15)] rounded-2xl transform transition-all duration-300 hover:-translate-y-1">
            ...
            <h2 class="text-4xl font-extrabold text-center mb-8 text-transparent bg-clip-text bg-gradient-to-r from-[#1E5C4F] to-[#4ade80]">Masuk</h2>
            ...
            <p class="text-center mt-6 text-gray-600">
                Belum punya akun?
                <a href="/register" class="text-[#1E5C4F] font-semibold hover:text-[#4ade80] transition-colors">Daftar</a>
            </p>
