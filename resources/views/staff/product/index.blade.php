    ...
    <div class="content">
        ...
        <div class="main">
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:30px;">
                <h2 style="margin: 0; color: #333; font-size: 24px;">Produk</h2>

                <div style="display: flex; gap: 15px;">
                    <form action="{{ route('staff.product.index') }}" method="GET" class="search-container">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari produk..." class="search-input">
                        <button type="submit" class="btn-search">Cari</button>
                    </form>

                    <a href="{{ route('staff.product.create') }}" class="btn btn-add">
                        + Tambah Produk
                    </a>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-flex">
                                <a href="{{ route('staff.product.edit',$product->id) }}" class="btn btn-edit">Ubah</a>

                                <form action="{{ route('staff.product.destroy',$product->id) }}" method="POST" style="display:inline;">
                                    @csrf 
                                    @method('DELETE')
