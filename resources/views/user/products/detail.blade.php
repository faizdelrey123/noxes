...
<head>
    <title>Detail Produk - LA PRIMERA</title>
...
<body class="bg-[#F5F5F5]">
    ...
    <nav class="bg-white px-16 py-6 flex justify-between items-center shadow-sm">
        <h1 class="text-4xl font-bold text-[#1E5C4F]">
            <a href="{{ route('home') }}">LA PRIMERA</a>
        </h1>
        ...
        <div class="flex items-center space-x-6">
            ...
            @else
                <a href="javascript:void(0)"
                    onclick="alert('Harap masuk terlebih dahulu!'); window.location.href='{{ route('login') }}';"
                    class="relative">
                    <img src="{{ asset('images/cart.png') }}" alt="Cart"
                        class="w-8 h-8 object-contain hover:scale-110 transition">
                </a>
    ...
    <section class="py-20 px-24 grid grid-cols-2 gap-20">
        ...
        <!-- IMAGE -->
        <div>
            <img src="{{ asset('products/' . $product->image) }}" width="200" class="w-full rounded-xl shadow">
        </div>
        ...
        <div>
            ...
            @if($product->series)
                <p class="text-lg text-gray-500 uppercase tracking-widest mb-6 font-medium" style="margin-top:-10px;">
        ...
        @endif
            ...
            @auth
                <form action="{{ route('cart.add', $product->id) }}" method="POST">
                    ...
                    <button
                        class="bg-[#1E5C4F] text-white w-80 py-4 rounded-xl text-xl font-semibold hover:opacity-90 transition">
                        ADD TO CART
                    </button>
                </form>
            @else
                <div class="flex items-center border w-36 justify-between px-4 py-2 mb-8 opacity-50 cursor-not-allowed">
                ...
                <a href="{{ route('login') }}"
                    class="inline-block text-center bg-[#1E5C4F] text-white w-80 py-4 rounded-xl text-xl font-semibold hover:opacity-90 transition">
                    Tambah ke Keranjang
                </a>
            @endauth
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <!-- TikTok -->
                        <a href="URL_TIKTOK_DISINI" target="_blank"
                            ...
                            <svg class="w-5 h-5 fill-current" viewBox="0 0 448 512">
                                <path
                                    d="M448 209.91a210.06 210.06 0 01-122.77-39.25v178.72A162.55 162.55 0 11185 188.31v89.89a74.62 74.62 0 1052.23 71.18V0l88 0a121.18 121.18 0 001.86 22.17h0A122.18 122.18 0 00381 102.39a121.43 121.43 0 0067 20.14z" />
                            </svg>
                        </a>

                        <!-- Instagram -->
                        <a href="URL_INSTAGRAM_DISINI" target="_blank"
                            class="w-10 h-10 bg-gray-100 text-gray-600 rounded-full flex items-center justify-center hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-600 hover:text-white shadow hover:shadow-md transition">
                            <svg class="w-5 h-5 fill-current" viewBox="0 0 448 512">
                                <path
                        ...
                        <!-- YouTube -->
                        <a href="URL_YOUTUBE_DISINI" target="_blank"
                            class="w-10 h-10 bg-gray-100 text-gray-600 rounded-full flex items-center justify-center hover:bg-[#FF0000] hover:text-white shadow hover:shadow-md transition">
                        ...
                        <!-- Twitter (X) -->
                        <a href="URL_TWITTER_DISINI" target="_blank"
                            class="w-10 h-10 bg-gray-100 text-gray-600 rounded-full flex items-center justify-center hover:bg-black hover:text-white shadow hover:shadow-md transition">
                            <svg class="w-4 h-4 fill-current" viewBox="0 0 512 512">
                                <path
                                    d="M389.2 48h70.6L305.6 224.2 487 464H345L233.6 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z" />
                            </svg>
                        </a>

                        <!-- Facebook -->
                        <a href="URL_FACEBOOK_DISINI" target="_blank"
                            class="w-10 h-10 bg-gray-100 text-gray-600 rounded-full flex items-center justify-center hover:bg-[#1877F2] hover:text-white shadow hover:shadow-md transition">
