...
<html>
<head>
    <title>Dashboard - LA PRIMERA</title>
...
<section class="relative">
    ...
    <div class="absolute bottom-10 left-10 text-white text-6xl font-bold drop-shadow-lg">
...
<div class="marquee">
    <div class="marquee-content">
        ✨ TEMUKAN GAYA TERBAIKMU BERSAMA LA PRIMERA! KAMI MENYEDIAKAN BACKPACK BERKUALITAS PREMIUM UNTUK MENEMANI AKTIVITAS HARIANMU. RAIH KEPERCAYAAN DIRIMU SEKARANG JUGA! ✨
    </div>
</div>
...
<section class="py-16 text-center">
    ...
    <h2 class="text-3xl text-green-800 mb-12">Produk Baru</h2>
...
<section class="py-16 text-center bg-gray-50">
    ...
    <h2 class="text-3xl text-green-800 mb-12">Terlaris</h2>
