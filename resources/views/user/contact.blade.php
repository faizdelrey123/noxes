...
<html>
<head>
    <title>Contact Us - LA PRIMERA</title>
...
<!-- ================= HERO ================= -->
<section class="relative h-[450px] overflow-hidden flex items-center justify-center">
    <div class="absolute inset-0 bg-gradient-to-r from-[#1E5C4F]/90 to-black/60 z-10 w-full h-full"></div>
    <img src="{{ asset('images/bannerjans3.jpg') }}" alt="Contact LA PRIMERA" class="absolute inset-0 w-full h-full object-cover">
    
    <div class="relative z-20 text-center px-4 animate-[fadeIn_1s_ease-out]">
        <h2 class="text-white text-5xl md:text-7xl font-bold mb-4 tracking-tight drop-shadow-xl">Let's Connect</h2>
        <p class="text-gray-200 text-xl font-light">Kami selalu siap mendengar dari Anda.</p>
    </div>
</section>

<!-- ================= MAIN SECTION ================= -->
<section class="px-6 md:px-24 py-16 -mt-24 relative z-30">

    <div class="max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
        <!-- Header area -->
        <div class="bg-[#1E5C4F] text-white p-12 text-center relative overflow-hidden">
            <!-- Background Decoration -->
            <div class="absolute -bottom-24 -right-24 w-64 h-64 bg-white/10 rounded-full blur-2xl"></div>
            <div class="absolute top-10 -left-10 w-32 h-32 bg-[#4ade80]/20 rounded-full blur-xl"></div>
            
            <div class="relative z-10">
                <h3 class="text-3xl md:text-4xl font-bold mb-4">Informasi Kontak</h3>
                <p class="text-[#a7f3d0] text-lg max-w-2xl mx-auto">Punya pertanyaan, komentar, atau saran? Kami memprioritaskan pelanggan dan akan sangat senang mendengar dari Anda.</p>
            </div>
        </div>
        ...
        <div class="p-10 md:p-16">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="flex items-start gap-5 group p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300">
                    <div class="w-16 h-16 bg-[#1E5C4F]/5 rounded-2xl flex items-center justify-center text-[#1E5C4F] shrink-0 group-hover:bg-[#1E5C4F] group-hover:text-white transition-all duration-300 shadow-sm">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    </div>
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-2">Alamat Gudang</h4>
                        <p class="text-gray-600 leading-relaxed text-base">Pergudangan Ritz Park Blok BC-10/11.<br>Bohar, Taman, Sidoarjo - Jatim 61257</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-5 group p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-2">Phone / WhatsApp</h4>
                        <p class="text-gray-600 leading-relaxed text-base font-medium">+62-838-9635-0280</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-5 group p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed text-base font-medium">LA PRIMERAbackpack@gmail.com</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-5 group p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-2">Outlet Tersedia</h4>
                        <p class="text-gray-600 leading-relaxed text-base">Jakarta, Bandung, Bogor, Yogyakarta, Bekasi, Surabaya, Bali, Padang, Medan</p>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-6 py-16">
        ...
        <div class="mt-16 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center">
            <p class="text-sm text-gray-500">
                Â© {{ date('Y') }} LA PRIMERA Apparel Corp. Hak cipta dilindungi.
            </p>
